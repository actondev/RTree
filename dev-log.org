...
* TODO compare tree with Superliminal
  ...
  could not get to get 1-1 serialization, gave up.
  Using simple rect volume (not spherical volume) in superliminal version, was getting similar tree on 3x3 grid (9 entries). but then was getting differences.
  In general getting same tree height (height 6 vs 200x200)
** O2 , non randomized grid 200x200
   #+begin_quote
 -------------------------------------------------------------------------------
 200x2d rtree
 -------------------------------------------------------------------------------
 ...
 ../test/test.cpp:435: warning:
   init size 200 took 51ms

 ../test/test.cpp:462: warning:
   search x10000 13 ms 

 ../test/test.cpp:467: warning:
   copy took 3 ms 
   #+end_quote

  
   with simple rect volume. using spherical volume superliminal init is slightly slower!
** performance: incl source vs static link
*** src
    #+begin_quote
 ../test/test.cpp:426: warning:
   init size 200 took 47ms

 ../test/test.cpp:453: warning:
   search x10000 13 ms 

 ../test/test.cpp:458: warning:
   copy took 2 ms 

 ../test/test.cpp:479: warning:
   removing fat cross took 6 ms 
